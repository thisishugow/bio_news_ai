...
class SeleniumURLLoader(BaseLoader):
    ...
    def __init__(
        ...
        browser: Literal["chrome", "firefox", "chromium"] = "chrome",
    ...
    def _get_driver(self) -> Union["Chrome", "Firefox"]:
        ...
        if self.browser.lower() == "chrome":
        ...
        elif self.browser.lower()=='chromium':
            ...
            if self.binary_location is not None:
                chrome_options.binary_location = self.binary_location
            if self.executable_path is None:
                return ChromiumDriver(options=chrome_options)
            return ChromiumDriver(
                options=chrome_options,
                service=ChromiumService(executable_path=self.executable_path),
            )
        else:
